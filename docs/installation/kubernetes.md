...
| RESOURCE_ALLOWED_ACCESS_LEVELS                  | Access levels a room owner or administrator may set, on create and on update. Rooms created before a level is removed keep it                                | public,trusted,restricted                                                                                                                                     |
